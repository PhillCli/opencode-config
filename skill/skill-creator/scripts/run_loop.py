...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=60,
        help="Timeout per query in seconds (opencode run startup is slower than a lightweight CLI prompt)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model",
        required=True,
        help="Model for improvement (OpenCode format, e.g. opencode-go/deepseek-v4-flash)",
    )
    parser.add_argument(
